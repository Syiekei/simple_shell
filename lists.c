...
/**
 * add_node - a node added at the start of the list
...
/**
 * add_node_end - node added at the end of the list
 * @head: pointer address to head node
 * @str: field of node
 * @num: index node used by history
 *
...
/**
 * print_list_str - the str element of a list_t linked list printed only
